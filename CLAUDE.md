...
**Issue Resolved**: SQLite concurrency problems between collection scripts and Flask app have been addressed with robust connection management in database classes.
